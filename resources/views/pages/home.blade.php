    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative z-10">
                ...
                <span class="inline-block px-4 py-1.5 mb-6 text-sm font-semibold tracking-wide rounded-full bg-primary/10 text-primary">
                    AUTHENTIC TASTE
                </span>

                <h1 class="text-5xl lg:text-7xl font-black leading-tight mb-6 text-slate-900 ">
                    Delicious <span class="text-primary">Homemade</span> Catering
                </h1>

                <p class="max-w-xl mb-10 text-lg leading-relaxed text-slate-600 ">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <button class="px-8 py-4 text-lg font-bold text-white rounded-xl bg-primary shadow-xl shadow-primary/30 hover:scale-105 transition-transform">
                        View Menu
                    </button>

                    <button class="px-8 py-4 text-lg font-bold rounded-xl border-2 border-slate-200  bg-white  hover:bg-slate-50 transition-colors">
                        Order Now
                    </button>
                ...
                <div class="flex items-center gap-6 mt-12">
                    ...
                    <div class="flex -space-x-3">
                        ...
                        <div class="w-12 h-12 overflow-hidden bg-slate-200 border-4 rounded-full border-background-light">
                            <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuBStKLBqu56ZH31Hp0lB5kJaGBIdc9lkBsM1OHyjQ6rdiwFUAJUC05sQj2z7NH-KTM9zlHPeB_3bSSCjF0nmlujYbp0oeW2zP9ML4JJ5TflOiocKx_W8yJuxccX7zQWrrkojME7kpo0uuO7XFQd08OfqTOxPaHm0ObCCg4U6fBrduDettJQpB5Q7mQ66dF8MMbVLznUddBKo9DXFnDltxgDmm4MpA9FU6ZFMlQTH5yJG3g1JpCGPh2NV-Vwer6U4nH8R_2Abx8GNfTT"
                                 class="w-full h-full object-cover" alt="Customer">
                        </div>

                        <div class="w-12 h-12 overflow-hidden bg-slate-200 border-4 rounded-full border-background-light">
                            <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuBb9VSEtlZFmVs3QB0cyNOwYbSIbsb9wcqLQrufbHFyoDYKT3Y42-7ubSumOOsx_ohsGBIQ6MgKwLXoLl0PjrAutAjhgf9Pqd-0GkK5a3E2L40leFanSck4sXd9UQrGinannEXXGAhcYiaz7Um2nuPscWghP9VB18InaADfVJ7fL9MEZ8n4y_BsjmLegooigdr5LmdAZYgiT75-u6pZq2FQ_5FW083uc2bGg8d-P5bXKpIceDxzT0cdc-12Y2q1huJ-zUNgu9iKleHP"
                                 class="w-full h-full object-cover" alt="Customer">
                        </div>

                        <div class="w-12 h-12 overflow-hidden bg-slate-200 border-4 rounded-full border-background-light">
                            <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuApptrWG5Gtw5JxQg4Rc3tYuoVgiYCODYLRwsZw3B9zuha9q_6SYxWG56IHjiQzHxXIbCt3w_8Kh-uFZsDCExJx-Mkx5fKZ8rXK8WAtzB7W_HJyKDg2kjotmLJg8WL8ofeiYELVVvrMRN_mhzZbdKHBq-Xov_7u1TqUDOs5XfeG1kP9UZ_3h9tNfO0_LRDqeGEtPRpAA4F7QSJcnQ-PL8b3Zv7OdoCR0UzSZHdcRkLd4M6f7i_YKe84dZtL3vWa-dsspP56qM27kmtM"
                                 class="w-full h-full object-cover" alt="Customer">
                        </div>
...
<!-- Why Choose Us -->
<section id="why-us" class="py-28 bg-background-light ">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-20">
            ...
            <h2 class="text-4xl lg:text-5xl font-black mt-3 mb-5 tracking-tight text-slate-900 ">
                Why Choose Us
            </h2>

            <p class="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <!-- Feature 1 -->
            <div class="group p-10 rounded-3xl bg-white border-primary/10 hover:border-primary/30 hover:shadow-xl transition-all">
            ...
            <div class="group p-10 rounded-3xl bg-white  border-primary/10 hover:border-primary/30 hover:shadow-xl transition-all">
                ...
                <div class="w-16 h-16 rounded-2xl bg-secondary/10 flex items-center justify-center mb-8
                    ...
                    <span class="material-symbols-outlined text-secondary group-hover:text-white text-3xl">
                        home
                    </span>
...
<!-- Testimonials -->
<section id="testimonials" class="py-28 bg-primary/5">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <!-- Testimonial 1 -->
            <div class="group bg-white p-8 rounded-3xl border border-primary/10 hover:border-primary/30 hover:shadow-xl transition-all">
                ...
                <!-- Quote -->
                <p class="text-slate-600  mb-7 leading-relaxed italic">
...
<section class="py-28">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative overflow-hidden rounded-[3rem] bg-slate-900 px-10 py-16 lg:px-20 lg:py-20">

            <!-- Background Glow -->
            <div class="absolute -top-20 -left-20 w-96 h-96 bg-primary/30 blur-[120px] rounded-full"></div>
            <div class="absolute -bottom-20 -right-20 w-96 h-96 bg-secondary/30 blur-[120px] rounded-full"></div>

            <!-- Overlay -->
            <div class="absolute inset-0 bg-gradient-to-r from-primary/20 via-transparent to-secondary/20 mix-blend-overlay"></div>
            ...
            <div class="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
                ...
                <div class="text-center lg:text-left max-w-xl">
                    ...
                    <h2 class="text-4xl lg:text-5xl font-black text-white mt-3 mb-6 leading-tight">
                        Planning an Event?
                    </h2>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <button class="bg-primary text-white px-10 py-4 rounded-2xl font-bold text-lg hover:scale-105 transition-transform shadow-xl shadow-primary/40">
                        Get a Quote
                    </button>

                    <button class="bg-white text-slate-900 px-10 py-4 rounded-2xl font-bold text-lg hover:bg-slate-100 transition-colors shadow-md">
                        Call Us Now
                    </button>
